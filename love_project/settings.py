...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'django-insecure-6&exn03+_flz=5i5jzjwh)2jug@-#w#@5fdp2lmb8c-xdd4$!d')
...
if configured_hosts:
    ALLOWED_HOSTS.extend([host.strip() for host in configured_hosts.split(',') if host.strip()])

render_host = os.environ.get('RENDER_EXTERNAL_HOSTNAME')
if render_host:
    ALLOWED_HOSTS.append(render_host.strip())
    ALLOWED_HOSTS.append(f"*.{render_host.strip()}")
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'romantic' / 'templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
